...
# Function: simulation of 40->1 small motif 
# Pipeline stage script for OmniCNN connectivity inference -- python scripts/01_simulate_many_to_one.py --help
"""
...
import signals, neuron, simulation
...
# Presynaptic 
# --------------------------------------------------------------------------------------
preE_kwargs = [{'lr_stdp_postSyn':0, 'lr_stdp_preSyn':0,'lr_istdp':0,              # to disable STDP
